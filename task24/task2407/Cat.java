...
будет
нужно
закастить класс к какому-нибудь интерфейсу (тут Sayable),
который
 не
 реализован в текущем классе
 */
public class Cat implements Pet {
	...
	public Sayable toSayable(final int i) {
		...
		class ClassPet implements Sayable {
			@Override
			public String say() {
				...
				if(i < 1) {
                    ...
                    return String.format("%s говорит м%sу!", name, meow);
                }
			}
		}
		return new ClassPet();
