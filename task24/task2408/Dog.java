...
будет
нужно
закастить класс к какому-нибудь другому классу, не интерфейсу :)))
Класс
DogPet
использует 2 класса - SuperDog и Dog, разберись с getName в классе DogPet
Так
намного
 лучше,
  чем
	...
	public Sayable toSayable(final int i) {
		...
		class DogPet extends SuperDog implements Sayable {
			...
			private String getName() {
				return String.format("%s%s%s", superDog.getSuperQuotes(), name, superDog.getSuperQuotes());
			}
